...
router.register(r'agent_properties', agent_viewserts.PropertyViewSet, basename='property')
router.register(r'agent_properties_items', agent_viewserts.PropertyItemViewSet, basename='propertyitem')
